            ...
            <form action="{{ route('centros.store') }}" method="POST" class="p-8 space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-center space-x-4">
                        <input type="color" name="color_tema" id="color_tema" required
                            class="w-12 h-12 rounded-md border border-gray-300 cursor-pointer">
                ...
                <div class="flex justify-end items-center space-x-3">
                    <a href="{{ route('centros.index') }}"
                        class="px-5 py-3 bg-gray-300 text-gray-700 rounded-md hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-500">
                        Cancelar
                    </a>
                    <button type="submit"
                        class="px-5 py-3 bg-teal-600 text-white rounded-md hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-500">
                        Guardar
                    </button>
                </div>
            </form>
